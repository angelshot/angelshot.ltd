...
export default () => (
  <Layout>
    ...
    <section id="privacy" class="sectionContainer floral col-2">
      <h2>
      ...
      <p>
        ...
        Terms govern and apply to your access and use of the programs offered by
        AngelShot Ltd (&ldquo;AngelShot&rdquo;, &quot;Company&quot;,
        ...
        (&ldquo;AngelBot&rdquo;) (all hereinafter collectively, &quot;AngelShot
        Services&quot;, &ldquo;Services&rdquo;) and any information, text,
        graphics, photos or other materials uploaded, downloaded or appearing on
        our Service (collectively referred to as &quot;Content&quot;). By
        accessing or using our Services, you agree to comply with and to be
        bound by all of the terms and conditions described in these Terms. If
        you do not agree to all of these terms and conditions, you are not
        authorized to use our Services. The terms &ldquo;You&quot;,
        &quot;Your,&rdquo; and &ldquo;Yourself&rdquo; refer to the individual
      ...
      <p>
        ...
        limited license to access and use our Services and to download or print
        ...
        rights not expressly granted to you in and to our Services, the Content
        and the Marks.
      </p>
      ...
      <p>
        ...
        the age of 13; (5) you are not a minor in the jurisdiction in which you
        reside, or if a minor, you have received parental permission to use our
        Services; (6) you will not access our Services through automated or
        non-human means, whether through a bot, script, or otherwise; (7) you
        will not use our Services for any illegal or unauthorized purpose; and
        (8) your use of our Services will not violate any applicable law or
        regulation.
      </p>
      ...
      <ol>
        ...
        <li>
          ...
          features of our Services, including features that prevent or restrict
          the use or copying of any Content or enforce limitations on the use of
          our Services and/or the Content contained therein.
        </li>
        <li>
        ...
        <li>
          Use our Services in a manner inconsistent with any applicable laws or
          regulations.
        </li>
        <li>
          ...
          interferes with any party&rsquo;s uninterrupted use of our Services or
        ...
        <li>
          ...
          engaged in providing any portion of our Services to you.
        </li>
        <li>
          Attempt to bypass any measures of our Services designed to prevent or
          restrict access to the Site, or any portion of our Services.
        </li>
        <li>
        ...
        <li>
          Use our Services as part of any effort to compete with us or otherwise
          use our Services and/or the Content for any revenue-generating
      ...
      <p>
        ...
        without limitation, notice, or liability, to remove from our Services or
        otherwise disable all files and content that are excessive in size or
        are in any way burdensome to our systems; and (5) otherwise manage our
        Services in a manner designed to protect our rights and property and to
        facilitate the proper functioning of our Services.
      </p>
      <h2>Privacy Policy</h2>
      <p>
        We care about data privacy and security. Please review our Privacy
        Policy: <Link to="/privacy">https://www.angelshot.ltd/privacy</Link>. By
        using our Services, you agree to be bound by our Privacy Policy, which
        is incorporated into these Terms of Use. Please be advised our Services
        are hosted in the United States. If you access our Services from any
        ...
        laws in the United States, then through your continued use of our
        ...
        accordance with the U.S. Children&rsquo;s Online Privacy Protection Act,
        ...
        parental consent, we will delete that information from our Services as
      ...
      <p>
        ...
        OR LIABILITY, DENY ACCESS TO AND USE OF OUR SERVICES (INCLUDING BLOCKING
        CERTAIN IP ADDRESSES), TO ANY PERSON FOR BREACH OF ANY REPRESENTATION,
        ...
        IN OUR SERVICES OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION
      ...
      <p>
        ...
        of our Services without notice at any time. We will not be liable to you
        or any third party for any modification, price change, suspension, or
        discontinuance of our Services.
      </p>
      <p>
        We cannot guarantee our Services will be available at all times. We may
        experience hardware, software, or other problems or need to perform
        maintenance related to our Services, resulting in interruptions, delays,
        or errors. We reserve the right to change, revise, update, suspend,
        discontinue, or otherwise modify our Services at any time or for any
        reason without notice to you. You agree that we have no liability
        whatsoever for any loss, damage, or inconvenience caused by your
        inability to access or use our Services during any downtime or
        discontinuance of our Services. Nothing in these Terms of Use will be
        construed to obligate us to maintain and support our Services or to
      ...
      <p>
        ...
        ATTORNEY-CLIENT RELATIONSHIP BETWEEN THE ANGELSHOT AND ANY OTHER PARTY.
      </p>
      <p>
        YOU ACKNOWLEDGE AND AGREE THAT OUR SERVICES AND THE CONTENT THEREIN ARE
        PROVIDED ON AN &quot;AS IS&quot; AND &quot;AS AVAILABLE&quot; BASIS.
        NONE OF ANGELSHOT, ANY OF ITS MEMBERS, AFFILIATES OR THEIR RESPECTIVE
        OFFICERS, DIRECTORS, EMPLOYEES OR AGENTS (COLLECTIVELY THE
        &quot;ANGELSHOT PARTIES&quot;) GUARANTEES THE ACCURACY, COMPLETENESS, OR
        USEFULNESS OF ANY OF THE CONTENT.
      </p>
      <p>
        ...
        RISK AS TO THE QUALITY AND PERFORMANCE OF OUR SERVICES AND THE ACCURACY
      ...
      <p>
        ...
        EXPRESS OR IMPLIED, REGARDING OUR SERVICES OR ANY CONTENT, INCLUDING
        ...
        ANGELSHOT PARTIES DISCLAIM ANY WARRANTIES WITH RESPECT TO ANY RESULTS
        THAT MAY BE OBTAINED FROM THE USE OF OUR SERVICES.
      </p>
      ...
      <p>
        ...
        OBTAINED THROUGH THE CONTENT ON THE WEB SITE. IT IS YOUR RESPONSIBILITY
        TO EVALUATE THE ACCURACY, COMPLETENESS, OR USEFULNESS OF ANY INFORMATION
        OR ANY CONTENT AVAILABLE THROUGH THE WEB SITE.
      </p>
      <p>
      ...
      <p>
        YOUR SOLE AND EXCLUSIVE REMEDY FOR DISSATISFACTION WITH OUR SERVICES IS
      ...
      <p>
        ...
        overt harmful act toward any other user of our Services with whom you
        connected via our Services. Notwithstanding the foregoing, we reserve
      ...
      <h2>User Data</h2>
      <p>
        We will maintain certain data that you transmit to our Services for the
        purpose of managing the performance of our Services, as well as data
        relating to your use of our Services. Although we perform regular
      ...
      <p>
        ...
        electronically, via email, text messaging, and on the Site, satisfy any
        ...
        TRANSACTIONS INITIATED OR COMPLETED BY US, VIA THE SITE, OR VIA
        ANGELBOT. You hereby waive any rights or requirements under any
      ...
      <p>
        ...
        between you and us as a result of these Terms of Use or use of our
      ...
      <p>
        ...
        further information regarding use of our Services, please contact us at:
        hi@angelshot.ltd
      </p>
    </section>
  </Layout>
